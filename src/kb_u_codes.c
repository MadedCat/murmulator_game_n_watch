...
typedef struct code_to_char{
   uint32_t mask;
   uint8_t  bank;
   uint8_t  symbol;
} __attribute__((packed)) code_to_char;

code_to_char __in_flash() kb_to_char_table[TRANSCH_TABLE_SIZE]={
	{KB_U1_1					,0x01,'1'},
	{KB_U1_2					,0x01,'2'},
	{KB_U1_3					,0x01,'3'},
	{KB_U1_4					,0x01,'4'},
...
uint8_t convert_kb_u_to_char(kb_u_state kb_st, bool only_num){
	for (uint8_t idx=TRANSCH_TABLE_SIZE-1;idx--;){
		if(only_num){
			if(idx<20){
				if(kb_st.u[kb_to_char_table[idx].bank]&kb_to_char_table[idx].mask){
					return kb_to_char_table[idx].symbol;
				}
			}
		} else {
			if(kb_st.u[kb_to_char_table[idx].bank]&kb_to_char_table[idx].mask){
...
typedef struct code_to_text{
	uint32_t mask;
    uint8_t bank;
    char text[15];
} __attribute__((packed)) code_to_text;

code_to_text __in_flash() kb_to_text_table[TRANSTX_TABLE_SIZE]={
    //bank 0
	{KB_U0_A			,0,"A\0"},
	{KB_U0_B			,0,"B\0"},
	{KB_U0_C			,0,"C\0"},
	...
	{KB_U1_8			,1,"8\0"},
	{KB_U1_9			,1,"9\0"},
	{KB_U1_ENTER		,1,"ENTER\0"},
	{KB_U1_SLASH		,1,"/\0"},
	{KB_U1_MINUS		,1,"-\0"},
	{KB_U1_EQUALS		,1,"=\0"},
	{KB_U1_BACKSLASH	,1,"\\\0"},
	{KB_U1_CAPS_LOCK	,1,"CS LCK\0"},
	{KB_U1_TAB			,1,"TAB\0"},
	{KB_U1_BACK_SPACE	,1,"BCK_SPACE\0"},
	{KB_U1_ESC			,1,"ESC\0"},
	{KB_U1_TILDE		,1,"`\0"},
	{KB_U1_MENU			,1,"MENU\0"},
	{KB_U1_L_SHIFT		,1,"L.SHIFT\0"},
	{KB_U1_L_CTRL		,1,"L.CTRL\0"},
	{KB_U1_L_ALT		,1,"L.ALT\0"},
	{KB_U1_L_WIN		,1,"L.WIN\0"},
	{KB_U1_R_SHIFT		,1,"R.SHIFT\0"},
	{KB_U1_R_CTRL		,1,"R.CTRL\0"},
	{KB_U1_R_ALT		,1,"R.ALT\0"},
	{KB_U1_R_WIN		,1,"R.WIN\0"},
	{KB_U1_SPACE		,1,"SPACE\0"},
	//bank 2
	{KB_U2_NUM_0		,2,"NUM 0\0"},
	{KB_U2_NUM_1		,2,"NUM 1\0"},
	{KB_U2_NUM_2		,2,"NUM 2\0"},
	{KB_U2_NUM_3		,2,"NUM 3\0"},
	{KB_U2_NUM_4		,2,"NUM 4\0"},
	{KB_U2_NUM_5		,2,"NUM 5\0"},
	{KB_U2_NUM_6		,2,"NUM 6\0"},
	{KB_U2_NUM_7		,2,"NUM 7\0"},
	{KB_U2_NUM_8		,2,"NUM 8\0"},
	{KB_U2_NUM_9		,2,"NUM 9\0"},
	{KB_U2_NUM_ENTER	,2,"NUM ENTER\0"},
	{KB_U2_NUM_SLASH	,2,"NUM /\0"},
	{KB_U2_NUM_MINUS	,2,"NUM -\0"},
	{KB_U2_NUM_PLUS		,2,"NUM +\0"},
	{KB_U2_NUM_MULT		,2,"NUM *\0"},
	{KB_U2_NUM_PERIOD	,2,"NUM .\0"},
	{KB_U2_NUM_LOCK		,2,"NUM LCK\0"},
	
	{KB_U2_DELETE		,2,"DELETE\0"},
	{KB_U2_SCROLL_LOCK	,2,"SCR LCK\0"},
	{KB_U2_PAUSE_BREAK	,2,"PSE/BRK\0"},
	{KB_U2_INSERT		,2,"INSERT\0"},
	{KB_U2_HOME			,2,"HOME\0"},
	{KB_U2_PAGE_UP		,2,"PG UP\0"},
	{KB_U2_PAGE_DOWN	,2,"PG DOWN\0"},
	{KB_U2_PRT_SCR		,2,"PRT SCR\0"},
	{KB_U2_END			,2,"END\0"},
	{KB_U2_UP			,2,"UP\0"},
	{KB_U2_DOWN			,2,"DOWN\0"},
	{KB_U2_LEFT			,2,"LEFT\0"},
	{KB_U2_RIGHT		,2,"RIGHT\0"},
	//bank 3
	{KB_U3_F1			,3,"F1\0"},
	{KB_U3_F2			,3,"F2\0"},
	{KB_U3_F3			,3,"F3\0"},
...
bool convert_kb_u_to_str(char* str_buf, kb_u_state kb_st){
	for (uint8_t idx=TRANSCH_TABLE_SIZE-1;idx--;){
		if(kb_st.u[kb_to_char_table[idx].bank]&kb_to_char_table[idx].mask){
			strcpy(str_buf,kb_to_text_table[idx].text);
			return true;
		}
	}
	return false;

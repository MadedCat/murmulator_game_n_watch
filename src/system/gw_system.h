...
void gw_system_blit(uint8_t *active_framebuffer);
...
extern volatile uint8_t mspeaker_data;
...
#define GW_BUTTON_LEFT  (0x01)
#define GW_BUTTON_UP    (0x02)
#define GW_BUTTON_RIGHT (0x04)
#define GW_BUTTON_DOWN  (0x08)
#define GW_BUTTON_A     (0x10)
#define GW_BUTTON_B     (0x20)
#define GW_BUTTON_TIME  (0x40)
#define GW_BUTTON_GAME  (0x80)
